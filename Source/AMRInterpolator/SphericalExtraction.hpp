...
struct spherical_extraction_params_t : surface_extraction_params_t
{
    ...
    operator=(const spherical_extraction_params_t &other)
    {
        surface_extraction_params_t::operator=(other);

        num_extraction_radii = num_surfaces;
        extraction_radii = surface_param_values;
        num_points_theta = num_points_u;
        num_points_phi = num_points_v;
        center = other.center;
...
class ModeExtraction : public SurfaceExtraction<spherical_geometry>
{
  public:
    ...
    using vars_t = SurfaceExtraction<spherical_geometry>;
