                                           ...
                                           MPI_Datatype type)
{
    ...
    //#if MPI_VERSION >= 3
    //    MPI_Ialltoallv(sendbuf, m_query.countsPtr(), m_query.displsPtr(),
    //    type,
    //                   recvbuf, m_answer.countsPtr(), m_answer.displsPtr(),
    //                   type, Chombo_MPI::comm, &m_mpi_requests.back());
    //#else
                                            ...
                                            MPI_Datatype type)
{
    ...
    //#if MPI_VERSION >= 3
    //    MPI_Ialltoallv(sendbuf, m_answer.countsPtr(), m_answer.displsPtr(),
    //    type,
    //                   recvbuf, m_query.countsPtr(), m_query.displsPtr(),
    //                   type, Chombo_MPI::comm, &m_mpi_requests.back());
    //#else
...
inline void MPIContext::asyncEnd()
{
    ...
    //#if MPI_VERSION >= 3
    //    MPI_Waitall(m_mpi_requests.size(), &m_mpi_requests[0],
    //    MPI_STATUSES_IGNORE);
    //#endif
