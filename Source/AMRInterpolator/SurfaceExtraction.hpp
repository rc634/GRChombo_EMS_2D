...
struct surface_extraction_params_t
{
    ...
    operator=(const surface_extraction_params_t &other)
    {
        num_surfaces = other.num_surfaces;
        surface_param_values = other.surface_param_values;
        num_points_u = other.num_points_u;
        num_points_v = other.num_points_v;
        extraction_levels = other.extraction_levels;
        write_extraction = other.write_extraction;

        data_path = other.data_path;
        integral_file_prefix = other.integral_file_prefix;
        extraction_path = other.extraction_path;
        extraction_file_prefix = other.extraction_file_prefix;

        radii_idxs_for_extrapolation = other.radii_idxs_for_extrapolation;
