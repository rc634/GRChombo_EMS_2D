...
class SimulationParameters : public SimulationParametersBase
{
  public:
    ...
    void read_shared_params(GRParmParse &pp)
    {
        ...
        // Binary puncture tracking parameters
        pp.load("bh_tagging_buffer", bh_tagging_buffer, 0.5);
        pp.load("puncture_tag_max_levels", puncture_tag_max_levels,
                {max_level, max_level});
    ...
    void read_tp_params(GRParmParse &pp)
    {
        ...
        // BH spin and momenta
        std::array<double, 3> spin_minus, spin_plus;
        ...
        bh1_params.momentum[2] = 0.0;
        bh2_params.momentum[2] = 0.0;
        for (int i = 0; i < 3; i++)
        {
        ...
        for (int i = 0; i < 3; i++)
        {
            pout() << tp_params.par_P_plus[i] << " ";
        }
        pout() << "\nP_minus = ";
        for (int i = 0; i < 3; i++)
        {
            pout() << tp_params.par_P_minus[i] << " ";
        }
        ...
        for (int i = 0; i < 3; i++)
        {
            pout() << tp_params.par_S_plus[i] << " ";
        }
        pout() << "\nS_minus = ";
        for (int i = 0; i < 3; i++)
        {
            pout() << tp_params.par_S_minus[i] << " ";
        }
        pout() << "\n";
    ...
    double bh_tagging_buffer;
    std::array<int, 2> puncture_tag_max_levels;
